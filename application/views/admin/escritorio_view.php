<link href="<?=base_url('admin')?>/assets/plugins/fullcalendar/fullcalendar.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="<?=base_url()?>admin/assets/plugins/gritter/css/jquery.gritter.css" rel="stylesheet" type="text/css"/>
<link rel="stylesheet" href="<?=base_url()?>admin/assets/plugins/jquery-ricksaw-chart/css/rickshaw.css" type="text/css" media="screen" >
<link rel="stylesheet" href="<?=base_url()?>admin/assets/plugins/jquery-morris-chart/css/morris.css" type="text/css" media="screen">

<link href="<?=base_url()?>admin/assets/plugins/jquery-jvectormap/css/jquery-jvectormap-1.2.2.css" rel="stylesheet" type="text/css" media="screen"/>
<link href="<?=base_url()?>admin/assets/plugins/boostrap-checkbox/css/bootstrap-checkbox.css" rel="stylesheet" type="text/css" media="screen"/>
  ...
  <div class="page-content"> 
    ...
    <div class="content">  
	   ...
	   <div id="container">
		<div class="row spacing-bottom col2">	
						  ...
						  <br>
							<div class="notification-messages info">
								<div class="user-profile">
									<img src="<?=base_url('admin')?>/assets/img/profiles/c.jpg"  alt="" data-src="<?=base_url('admin')?>/assets/img/profiles/c.jpg" data-src-retina="<?=base_url('admin')?>/assets/img/profiles/c2x.jpg" width="35" height="35">
								</div>
							...
							<div class="notification-messages success">
								<div class="user-profile">
									<img src="<?=base_url('admin')?>/assets/img/profiles/h.jpg"  alt="" data-src="<?=base_url('admin')?>/assets/img/profiles/h.jpg" data-src-retina="<?=base_url('admin')?>/assets/img/profiles/h2x.jpg" width="35" height="35">
								</div>
								<div class="message-wrapper">
									<div class="heading">
						 ...
						 <div class="row">
							<div class="user-comment-wrapper col-mid-12">
								<div class="profile-wrapper">
									<img src="<?=base_url('admin')?>/assets/img/profiles/d.jpg"  alt="" data-src="<?=base_url('admin')?>/assets/img/profiles/d.jpg" data-src-retina="<?=base_url('admin')?>/assets/img/profiles/d2x.jpg" width="35" height="35">
								</div>
								<div class="comment">
									<div class="user-name">
...
<script src="<?=base_url()?>admin/assets/plugins/jquery-ricksaw-chart/js/raphael-min.js"></script> 
<script src="<?=base_url()?>admin/assets/plugins/jquery-ricksaw-chart/js/d3.v2.js"></script>

<script src="<?=base_url()?>admin/assets/plugins/jquery-morris-chart/js/morris.min.js"></script>
<script src="<?=base_url()?>admin/assets/plugins/jquery-easy-pie-chart/js/jquery.easypiechart.min.js"></script>

<script src="<?=base_url()?>admin/assets/plugins/jquery-jvectormap/js/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script> 	
<script src="<?=base_url()?>admin/assets/plugins/jquery-jvectormap/js/jquery-jvectormap-us-lcc-en.js" type="text/javascript"></script> 	
<script src="<?=base_url()?>admin/assets/plugins/jquery-sparkline/jquery-sparkline.js"></script>
<script src="<?=base_url()?>admin/assets/plugins/jquery-flot/jquery.flot.min.js"></script>
<script src="<?=base_url()?>admin/assets/plugins/jquery-flot/jquery.flot.animator.min.js"></script>
<script src="<?=base_url()?>admin/assets/plugins/skycons/skycons.js"></script>

<script src="<?=base_url()?>admin/assets/plugins/jquery-ricksaw-chart/js/rickshaw.min.js"></script>

<script src="<?=base_url()?>admin/assets/js/dashboard.js" type="text/javascript"></script>